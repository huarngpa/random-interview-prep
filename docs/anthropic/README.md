...
This folder is our working area for Anthropic loop prep.
...
- [Interview Problems](./interview-problems/README.md): curated LeetCode-style problems for Anthropic based on public interview signals and the compute-capacity role shape.

## Next Docs To Add

- `python-patterns.md`
- `mock-questions.md`
- `systems-story-bank.md`
